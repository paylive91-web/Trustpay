                    ...
                    orders.map((order: any) => (
                      <TableRow key={order.id}>
                        ...
                        <TableCell>
                          ...
                          <div className="text-xs text-green-600">+{order.rewardPercent}% (₹{order.rewardAmount}) = ₹{order.totalAmount}</div>
                        </TableCell>
                        <TableCell>
                          {order.type === 'deposit' ? (
                            <div className="text-xs">
                              Remitter: <span className="font-medium">{order.userName || '-'}</span>
                            </div>
                          ) : (
                            <div className="text-xs">
                              UPI: <span className="font-medium">{order.userUpiId}</span><br/>
                              Name: <span className="font-medium">{order.userUpiName}</span>
                            </div>
                          )}
                        </TableCell>
                        <TableCell>
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input 
                type="number" 
                value={editRewardPercent} 
                onChange={(e) => setEditRewardPercent(e.target.value)} 
              />
            </div>
          </div>
          <DialogFooter>
