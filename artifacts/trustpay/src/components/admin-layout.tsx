...
import { LayoutDashboard, Users, ListOrdered, Settings, CreditCard, ShieldAlert, LogOut, Eye, AlertTriangle, Download, Link2, ShieldCheck, BarChart3, Activity, MessageSquare, Brain, History, Radio, Coins } from "lucide-react";
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { href: "/admin/timeout-history", label: "Timeout History", icon: History, badge: 0 },
    ...
    { href: "/admin/usdt", label: "USDT", icon: Coins, badge: 0 },
    { href: "/admin/agents", label: "Agents", icon: ShieldCheck, badge: 0 },
    { href: "/admin/settings", label: "Settings", icon: Settings, badge: 0 },
    { href: "/admin/links-media", label: "Links & Media", icon: Link2, badge: 0 },
    { href: "/admin/reports", label: "Reports", icon: BarChart3, badge: 0 },
